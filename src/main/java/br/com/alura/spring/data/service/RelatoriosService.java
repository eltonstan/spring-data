...
public class RelatoriosService {
	...
	private void pesquisaFuncionarioSalario() {
        ...
        List<FuncionarioProjecao> funcionarios = this.funcionarioRepository.findFuncionarioSalario();
        funcionarios.forEach(funcionario -> {
        	System.out.println("Funcionario: Id: " + funcionario.getId() + " Nome: " + funcionario.getNome() + " Salario: " + funcionario.getSalario());
        });
